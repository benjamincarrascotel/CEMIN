                                ...
                                <div class="col-lg-6 col-xl-4 col-md-7 col-sm-12 col-xs-12 ">
                                    ...
                                    <div class="card-group mb-0">
                                        <div class="card bg-primary text-white br-7 p-2">
                                            ...
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <label class="custom-control custom-checkbox">
                                                        ...
                                                        <span class="custom-control-label text-white-50">Remember Me <a href="javascript:void(0);" class="btn-link text-white float-end">Forget password ?</a></span>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-white text-primary btn-block d-grid px-4 font-weight-bold">Log In</button>
                                                </div>
                                            </div>
